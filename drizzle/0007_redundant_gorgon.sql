...
-- REFRESH MATERIALIZED VIEW CONCURRENTLY requires (kat-crons'
-- dashboard-recap-refresh job) must be recreated every time this view is
-- dropped+recreated — see 0003/0005 for the same fix, needed again here.
